...
- BF16/FP16 dropout, LoRA `dropout` field wiring, PyTorch bit-for-bit reproducibility, CUDA graph capture-friendly Philox snapshot — all listed as future work in `docs/generator-design.md` §5.
```
